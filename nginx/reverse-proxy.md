...
### 3. /etc/nginx/nginxconfig.io/proxy.conf
```
...
### 4. /etc/nginx/nginxconfig.io/security.conf
```
# security headers
...
### 5. /etc/nginx/nginxconfig.io/general.conf
```
# favicon.ico
...
---
Refer2: https://www.digitalocean.com/community/tools/nginx?domains.0.https.certType=custom&domains.0.https.sslCertificate=%2Fetc%2Fnginx%2Fssl%2Fca.crt&domains.0.https.sslCertificateKey=%2Fetc%2Fnginx%2Fssl%2Fca.key&domains.0.php.php=false&domains.0.reverseProxy.reverseProxy=true&domains.0.routing.index=index.html&domains.0.routing.fallbackHtml=true